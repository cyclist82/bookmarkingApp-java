...
import de.awacademy.trillio.constants.Gender;
...
public class DataStore {
	...
	private static void loadUsers() {
		...
		users[4] = UserService.getInstance().createUser(1004, "user4@semanticsquare.com", "test", "Dheeru", "M", Gender.MALE, UserType.CHIEFEDITOR);
	}
